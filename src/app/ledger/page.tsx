      ...
      <div className="w-full max-w-7xl px-4 pt-6 z-40 mb-12">
        <nav className="glass-nav px-8 py-5 flex justify-between items-center shadow-sm">
          <Link href="/" className="flex items-center gap-4 cursor-pointer hover:-translate-y-1 transition-transform">
            ...
            <h1 className="font-serif font-black text-xl tracking-[0.2em] text-[#4a4238]">返回營運首頁</h1>
          </Link>
          <div className="flex gap-4">
             <button onClick={exportCurrentDay} className="hidden md:block bg-emerald-500 text-white px-6 py-2 rounded-full font-bold text-sm tracking-widest hover:bg-emerald-600 transition-colors">匯出當日 CSV</button>
             <h2 className="font-serif font-black text-2xl md:text-3xl tracking-[0.15em] text-[#c4a484] drop-shadow-sm">每日對帳單系統</h2>
          </div>
        </nav>
      </div>
