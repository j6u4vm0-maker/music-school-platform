...
function HolidaysContent() {
  ...
  return (
    <main className="min-h-screen bg-[#f8f7f2] flex flex-col relative overflow-hidden">
      ...
      {/* Navbar */}
      <Navbar pageTitle="老師排休管理系統">
        <div className="hidden md:flex items-center gap-4 bg-[#4a4238]/5 px-5 py-2.5 rounded-full border border-[#4a4238]/10 scale-90">
           <span className="text-[10px] font-black text-[#4a4238]/60 uppercase tracking-widest">目前日期:</span>
           <span className="text-xs font-black text-[#4a4238] tracking-widest">{new Date().toLocaleDateString('zh-TW')}</span>
        </div>
      </Navbar>
